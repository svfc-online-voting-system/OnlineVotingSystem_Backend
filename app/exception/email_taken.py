"""
            This file contains the custom exception for EmailAlreadyTaken.
            This exception will be raised when the
            user tries to create an account with an email that is already taken.
    """
